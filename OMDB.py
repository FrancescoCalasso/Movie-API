...
class OMDB_GUI:
    ...
    def build_profile(self, window):
        ...
        if tv_series > 0 or movie > 0:
            ...
            profile_layout1 = [
                ...
                [sg.Text('')],
                [sg.Text('Watchlist', font='Courier 25', size = (16,1)), sg.Text('Wantlist', font='Courier 25', size = (30,1))],
                [sg.Text('')]]

            list = [self.title_list(x, self.watchlist, self.want) for x in range(0, max(len(self.watchlist), len(self.want)))]
            ...
            layout = profile_layout1 + list + profile_layout2
            ...
            profile_layout = [
                ...
                [sg.Text(f'{self.username}', font='Courier 40')],
                [sg.Text('')],
                [sg.Text('Watchlist', font='Courier 16'), sg.Text('Wantlist', font='Courier 30')],
                [sg.Text('')],
                [sg.Button('Ok')]
            ]
    ...
    def build_main_layout(self):
        ...
        search_layout = [
            [sg.Text('Welcome to your personal Movie Database', font='Courier 20')],
    ...
    def build_search_layout(self):
        ...
        search_layout = [
            [sg.Text('Look for a TV show or a movie', font='Courier 20')],
    ...
    def title_list(self, i, list1, list2):

        """
        Defines the list of rows of watchlist next to wantlist
        :param i:
        :param list1:
        :param list2:
        :return:
        ...
        if i < len(list1) and i < len(list2):
            ...
            return [sg.Text(list1[i], font= 'Courier 20', size=(20,1)), sg.Text(list2[i], font= 'Courier 20', size=(20,1))]

        elif i < len(list1) and i >= len(list2):

            return [sg.Text(list1[i], font= 'Courier 20', size=(20,1))]

        elif i >= len(list1) and i < len(list2):

            return [sg.Text(list2[i], font= 'Courier 20', size=(20,1))]

    def single_list(self, i, list):
    ...
    def build_watchlist_layout(self):
        ...
        list = [self.single_list(x, self.watchlist) for x in range(0, len(self.watchlist))]
        ...
        watchlist_layout = watchlist_layout1 + list + watchlist_layout2
    ...
    def build_wantlist_layout(self):
        ...
        list = [self.single_list(x, self.want) for x in range(0, len(self.want))]
        ...
        wantlist_layout = wantlist_layout1 + list + wantlist_layout2
